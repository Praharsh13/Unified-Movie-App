...
// constants.js
export const USERS_URL = `${import.meta.env.VITE_API_URL}/movieapp/users`; // This should be correct for your proxy setup
...
export const WISHLIST_URL=`${import.meta.env.VITE_API_URL}/movieapp/wishlist`;
