//Creating UI for genreCreation, deletion and updation
const GenreForm = ({
    value,
    setValue,
    handleSubmit,
    ...
    return (
      <div className="p-3">
        <form onSubmit={handleSubmit} className="space-y-3">
          <input
            type="text"
            className="py-3 px-4 border border-red-500 rounded-lg w-[60rem] hover:border-red-600 focus:outline-none focus:border-red-600"
